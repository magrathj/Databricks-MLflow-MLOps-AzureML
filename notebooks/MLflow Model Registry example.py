...
# MAGIC %md # Setup
# MAGIC 
# MAGIC 1. Start a Databricks cluster with one of the following configurations:
# MAGIC    - Databricks Runtime 6.4 and MLflow 1.7.0 or above installed using PyPI.
# MAGIC    - Databricks Runtime 6.5 ML (Beta) or above.
...
# MAGIC 
# MAGIC There are now two model versions of the forecasting model in the **Production** stage: the model version trained in Keras model and the version trained in scikit-learn. 
# MAGIC 
